...
export const metadata: Metadata = {
  ...
  description: 'Portfólio pessoal de Carlos Henrique de Oliveira Henrique, Desenvolvedor Frontend Júnior especializado em React.js, TypeScript, Next.js e Tailwind CSS.',
  ...
  openGraph: {
    ...
    description: 'Portfólio pessoal de Carlos Henrique de Oliveira Henrique, Desenvolvedor Frontend Júnior',
    siteName: 'Carlos Henrique Portfolio',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Carlos Henrique | Desenvolvedor Frontend',
    description: 'Portfólio pessoal de Carlos Henrique de Oliveira Henrique',
