      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-4 font-mono neon-text-magenta">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-6">
              {stats.map((stat, index) => (
                <div key={index} className="neon-card rounded-xl p-6 transition-all duration-300 hover-lift">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="p-2 rounded cyber-border bg-gradient-to-br from-cyan-500/20 to-magenta-500/20" style={{ boxShadow: '0 0 10px rgba(0, 240, 255, 0.2)' }}>
                      {stat.icon}
                    </div>
            ...
            <div className="pt-4">
              <a 
                href="#contact" 
                className="futuristic-btn inline-flex items-center gap-2 px-8 py-3 rounded font-semibold font-mono transition-all duration-300 relative overflow-hidden group"
              >
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              <div className="w-80 h-80 lg:w-96 lg:h-96 rounded-2xl overflow-hidden cyber-border relative" style={{ boxShadow: '0 0 30px rgba(0, 240, 255, 0.3), 0 0 60px rgba(255, 0, 255, 0.2)' }}>
                <ProfileImage
                  src="/perfil-2.jpg"
              ...
              {/* Decorative Elements - Futuristic */}
              <div className="absolute -top-4 -right-4 w-8 h-8 bg-gradient-to-br from-cyan-400 to-magenta-500 rounded-full animate-pulse" style={{ boxShadow: '0 0 20px rgba(0, 240, 255, 0.6)' }}></div>
              <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-gradient-to-br from-magenta-500 to-purple-500 rounded-full animate-pulse" style={{ boxShadow: '0 0 15px rgba(255, 0, 255, 0.6)' }}></div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-20">
          <div className="grid md:grid-cols-3 gap-8">
            {highlights.map((highlight, index) => (
              <div key={index} className="neon-card text-center group p-6 rounded-xl hover-lift">
                <div className="text-4xl mb-4 group-hover:scale-110 transition-transform duration-300 filter drop-shadow-[0_0_8px_rgba(0,240,255,0.6)]">
                  {highlight.icon}
                </div>
